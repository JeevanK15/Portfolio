...
export function Hero() {
  return (
    <section id="top" className="hero-stage relative isolate overflow-hidden">
      <div className="hero-grid">
        <div>
          <p className="technical-label animate-pulse">Available for internships &amp; project opportunities</p>
          <h1 className="hero-title">Jeevan<br /><span className="text-accent">K.</span></h1>
        ...
        <div className="hero-core" aria-label="Interactive digital core representing Jeevan's creative development system" role="img">
